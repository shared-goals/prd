...
|---|---|---|
| 1.34 | 2026-07-19 | README/ACCEPTANCE/IMPLEMENTATION: добавлен agent-facing endpoint `GET /api/v1/compass/next-steps` как platform feed для активных joined-contract `next_step` items без раскрытия private Markdown source text |
